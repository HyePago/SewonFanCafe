    ...
    <body>
        ...
        <form action="joinProc.jsp" method="post" class="event_form">
            <table class="event_table">
            	<%
	    	    	try {
	    	    		SQL = "SELECT * FROM to_sewoon WHERE id = ?";
                ...
                <tr style="vertical-align: bottom; text-align: right;">
                    <td colspan="2"><a href="to_sewoon.jsp?page=1">목록</a> &nbsp;&nbsp;|&nbsp;&nbsp; <a href="to_sewoon_view.jsp?id=<%= Integer.parseInt(id)+1 %>">▲윗글</a> &nbsp;&nbsp;|&nbsp;&nbsp; <a href="to_sewoon_view.jsp?id=<%= Integer.parseInt(id)-1 %>">▼아랫글</a></td>
                </tr>
                <%
                	try {
						SQL = "SELECT * FROM to_sewoon WHERE id = ?";
	    	    		...
	    	    		if(rs.next()) {
	    	    			%>
	    	    				 <tr>
				                    <td>▲윗글&nbsp;&nbsp;&nbsp;| <a href="to_sewoon_view.jsp?id=<%= Integer.parseInt(id)+1 %>"><%= rs.getString("title") %></a></td>
	    	    		...
	    	    		if(rs.next()) {
	    	    			%>
	    	    				 <tr>
				                    <td>▼아랫글&nbsp;| <a href="to_sewoon_view.jsp?id=<%= Integer.parseInt(id)-1 %>"><%= rs.getString("title") %></a></td>
				                    <td class="writting_time"><%= rs.getString("timestamp") %></td>
				                </tr>
	    	    			<%
	    	    		} else {
